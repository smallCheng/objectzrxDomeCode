...
bool CGeRectangleUtil::IntersectWithRectangle(const AcGePoint2d &rect1Point1, const AcGePoint2d &rect1Point2, const AcGePoint2d &rect2Point1, const AcGePoint2d &rect2Point2)
{
	//获得两个矩形的四个边界值
	...
	double tol = 1.0E-7;
	if (rect1MinX > rect2MaxX + tol || rect2MinX > rect1MaxX + tol || rect1MinY > rect2MaxY + tol || rect2MinY > rect1MaxY + tol)
	{
		return false;
	}
	else
