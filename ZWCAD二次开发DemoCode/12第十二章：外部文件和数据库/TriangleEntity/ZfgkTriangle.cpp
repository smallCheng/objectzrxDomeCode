	...
	AcDbIntArray &geomIds) const
{
	...
	Acad::ErrorStatus es=pPoly->getOsnapPoints(osnapMode,gsSelectionMark,pickPoint,lastPoint,viewXform,snapPoints,geomIds);
	delete pPoly;
...
//void ZfgkTriangle::set_ManagedWrapper(gcroot<zfgk::TrangleEntityDB::MgTriangle *> p)
//{
//	m_pManaged=p;
//}
//#endif
...
// -----------------------------------------------------------------------------
void ZfgkTriangle::list(void) const
{
	AcDbEntity::list();
