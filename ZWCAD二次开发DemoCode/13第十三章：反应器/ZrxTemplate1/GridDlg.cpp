...
IMPLEMENT_DYNAMIC (CGridDlg, CZcUiDialog)

BEGIN_MESSAGE_MAP(CGridDlg, CZcUiDialog)
...
//-----------------------------------------------------------------------------
CGridDlg::CGridDlg (CWnd* pParent /*=NULL*/, HINSTANCE hInstance /*=NULL*/) : CZcUiDialog (CGridDlg::IDD, pParent, hInstance) {
