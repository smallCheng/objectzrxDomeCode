...
class OrbitGadget : public ZcGiDrawable
{
    AcGsNode* m_pNode;
...
#if _MSC_VER < 1500
	virtual Adesk::UInt32   setAttributes   (ZcGiDrawableTraits * traits)
    {
...
#if _MSC_VER >= 1500
	virtual Adesk::UInt32   setAttributes   (ZcGiDrawableTraits * traits){ return 0; };

	virtual Adesk::Boolean  worldDraw       (AcGiWorldDraw * wd){ return Adesk::kTrue; };
