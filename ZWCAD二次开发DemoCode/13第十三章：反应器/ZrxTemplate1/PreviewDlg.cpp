...
//-----------------------------------------------------------------------------
IMPLEMENT_DYNAMIC (CPreviewDlg, CZcUiDialog)

BEGIN_MESSAGE_MAP(CPreviewDlg, CZcUiDialog)
...
//-----------------------------------------------------------------------------
CPreviewDlg::CPreviewDlg (CWnd* pParent /*=NULL*/, HINSTANCE hInstance /*=NULL*/) : CZcUiDialog (CPreviewDlg::IDD, pParent, hInstance) {
